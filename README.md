...
```bash
git clone https://github.com/SayanKar/decentralized-crowdfunding-platform.git
...
> **NOTE:** Set `WEB3_STORAGE_API_TOKEN` in `frontend/.env`.
> Also update contract address in `frontend/src/App.js` before running frontend.
<!-- <<< managed: repo-layout-readme <<< -->
